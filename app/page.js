...
const MOCK_GOVT_DB = {
    "987654321012": {
        ...
        state: "Maharashtra",
        gender: "Male",
        email: "aarav.s@example.com",     // Added
        mobile: "+91 98765 43210",       // Added
    ...
    "123456789012": {
        ...
        state: "Tamil Nadu",
        gender: "Female",
        email: "priya.v@example.com",     // Added
        mobile: "+91 91234 56789",       // Added
...
const SignInFlow = () => {
    ...
    const handleCredentialsSubmit = (e) => {
        ...
        // Simulate API check
        setTimeout(() => {
            // Hardcoded simulation: picking the first mock user
    ...
    return (
        <TwoFactorAuth user={currentUser} onBack={() => setStep('credentials')} />
    );
};
...
const TwoFactorAuth = ({ user, onBack }) => {
    const [step, setStep] = useState("mobile"); // mobile → email
        ...
        >
            ...
            <AnimatePresence>
                {sent ? (
                    ...
                    >
                        <InputField
                            label={`Enter OTP sent to your ${
                                step === "mobile" ? "mobile" : "email"
                            }`}
                            icon={Lock}
